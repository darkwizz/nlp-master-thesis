...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--revision', type=str.lower, required=True, help="model revision")
    ...
    parser.add_argument('--fp16', action='store_true', help='set fp16 flag during training')
    parser.add_argument('--patience', type=int, default=1, help='number of patience steps to decide that eval_loss definitely becomes worse. Used only when -r is "early_stopping"')
